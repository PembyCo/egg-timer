  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 max-w-md w-full">
      ...
      {timeLeft === 0 && isRunning && (
        <div className="mt-4 text-center text-amber-600 dark:text-amber-400 font-medium bg-amber-50 dark:bg-amber-900/20 p-3 rounded-lg border border-amber-200 dark:border-amber-700 animate-pulse">
          Your egg is ready!
        </div>
      )}
    </div>
